    ...
    public partial class addall : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelStars", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DistancetoCenter = table.Column<decimal>(type: "Money", nullable: false),
                    TreatmentPrice = table.Column<double>(type: "float", nullable: true),
                    TreatmentDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ChildDiscountId = table.Column<int>(type: "int", nullable: true),
                    isDeleted = table.Column<bool>(type: "bit", nullable: false),
                    HotelStarId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ChildDiscountId,
                        principalTable: "ChildrenDiscounts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Hotels_HotelStars_HotelStarId",
                        column: x => x.HotelStarId,
                        principalTable: "HotelStars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Withtreatment = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcceptReservationId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
