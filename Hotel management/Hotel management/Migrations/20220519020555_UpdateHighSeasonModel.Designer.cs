...
namespace Hotel_management.Migrations
{
    ...
    [Migration("20220519020555_UpdateHighSeasonModel")]
    partial class UpdateHighSeasonModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotel_management.Models.Months", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("HighSeasonId")
                        .HasColumnType("int");

                    b.Property<int?>("LowSeasonId")
                        .HasColumnType("int");

                    b.Property<int?>("MidSeasonId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HighSeasonId");

                    b.HasIndex("LowSeasonId");

                    b.HasIndex("MidSeasonId");
            ...
            modelBuilder.Entity("Hotel_management.Models.Months", b =>
                {
                    b.HasOne("Hotel_management.Models.HighSeason", null)
                        .WithMany("DateMonths")
                        .HasForeignKey("HighSeasonId");

                    b.HasOne("Hotel_management.Models.LowSeason", null)
                        .WithMany("Months")
                        .HasForeignKey("LowSeasonId");

                    b.HasOne("Hotel_management.Models.MidSeason", null)
                        .WithMany("Months")
                        .HasForeignKey("MidSeasonId");
                });
