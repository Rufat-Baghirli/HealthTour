...
namespace Hotel_management.Migrations
{
    ...
    [Migration("20220301111129_updateLocation_")]
    partial class updateLocation_
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotel_management.Models.Hotel_HotelFeatures", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("HotelFeaturesId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HotelFeaturesId");

                    b.HasIndex("HotelId");

                    b.ToTable("Hotel_HotelFeatures");
                });

            modelBuilder.Entity("Hotel_management.Models.HotelFeatureDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FeatureDescreption")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Hotel_management.Models.HotelFeatures", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_management.Models.Room_RoomFeatures", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_management.Models.Hotel_HotelFeatures", b =>
                {
                    b.HasOne("Hotel_management.Models.HotelFeatures", "HotelFeatures")
                        .WithMany("Hotel_HotelFeatures")
            ...
            modelBuilder.Entity("Hotel_management.Models.Hotel", b =>
                {
                    ...
                    b.Navigation("Hotel_HotelFeatures");
            ...
            modelBuilder.Entity("Hotel_management.Models.Room", b =>
                {
                    ...
                    b.Navigation("Room_RoomFeatures");
                });
