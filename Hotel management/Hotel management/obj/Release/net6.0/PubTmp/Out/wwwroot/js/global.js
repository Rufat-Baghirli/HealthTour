$(document).ready(function () {
    ...
    try {
        ...
        btnAddRoom.on('click', function (e) {
            ...
            <span class="list-room__name">${totalRoom}</span>
            <ul class="list-person">
                ...
                <li class="list-person__item ChildItems">
                    <span class="name">Children</span>
                    <select style="width: 70px;     width: 70px;
                    padding: 5px 0px;
                    margin-left: 12px;" name="ChildAge" id="childAge">
                    ...
                    <div class="quantity quantity2">
                        ...
                        <span class="plus" id="plusChild">+</span>
